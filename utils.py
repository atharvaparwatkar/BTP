...
train_article_path = "sumdata/train/train.articles"
train_title_path = "sumdata/train/train.summaries"
valid_article_path = "sumdata/train/test.articles"
valid_title_path = "sumdata/train/test.summaries"
...
def replace_dots(sent):
    return sent.replace("#", " DOT")
...
def build_dataset(step, word_dict, article_max_len, summary_max_len, toy=False):
    ...
    x = [replace_dots(d) for d in article_list]
